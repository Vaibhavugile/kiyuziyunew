...
import "./NewArrivalsSection.css"; // reuse same premium CSS
  ...
  useEffect(() => {
    const fetchTrending = async () => {
      try {
        ...
        const q = query(ref, where("tags", "array-contains", TRENDING_TAG));
    ...
    <section className="na-premium">
      ...
      <div className="na-hero">
        ...
        <div className="na-hero-content">
          <span className="na-eyebrow">Trending Now</span>

          {/* <h2>{featured.name}</h2> */}

          <p>
            Loved by our community and defined by bold design —
            these pieces are setting the tone this season.
          </p>
